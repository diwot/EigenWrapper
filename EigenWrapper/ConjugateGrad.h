...
{
	public ref class ConjugateGradient : public ISolver
	{
	private:
		Eigen::ConjugateGradient <SpMat>* data;

	public:
		ConjugateGradient()
		{
			data = new Eigen::ConjugateGradient<SpMat>();
		}
		~ConjugateGradient() { this->!ConjugateGradient(); }
		!ConjugateGradient()
		{
			if (data)
			{
