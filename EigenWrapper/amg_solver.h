...
//https://github.com/NTForked/amg-solver
namespace amg {
	...
	public:
		...
		amg_solver();
		amg_solver(size_t levels, size_t cycle, size_t iteration, size_t prev_smooth,
			size_t post_smooth, size_t fmg_inner_iteration, std::string smoother, std::string coarsener, std::string linear_solver, scalar tolerance/*const boost::property_tree::ptree &pt*/);
